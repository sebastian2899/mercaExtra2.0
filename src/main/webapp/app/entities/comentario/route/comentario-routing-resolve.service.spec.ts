...
describe('Comentario routing resolve service', () => {
  ...
  let resultComentario: IComentario | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new IComentario if id is not provided', () => {
      // GIVEN
      ...
      expect(resultComentario).toEqual(new Comentario());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Comentario })));
      mockActivatedRouteSnapshot.params = { id: 123 };
